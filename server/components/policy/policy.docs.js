/**
 * @swagger
 * /policy/get-by-user/{type}:
 *   get:
 *     summary: Get info Policy - Info - Instruction - Model - Recommendation by User
 *     tags:
 *       - Terms Policy - Information - Instruction - Model - Recommendation
 *     parameters:
 *       - name: "type"
 *         in: "path"
 ...
 *         in: body
 *         required: true
 *         description: Your policy/info/instruction/model/recommendation
 *         schema:
 *           type: object
 *           example: {
 *             "success": true,
